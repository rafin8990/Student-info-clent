...
const Update = ({ id }) => {
    ...
    const handleUpdate = (event) => {
        ...
        fetch(`https://student-info-server.vercel.app/update/${id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <div className='mt-20'>
            <Slide bottom>
                <h1 className='text-4xl text-center text-teal-900'>Update Students Details</h1>
            </Slide>
            <div className='flex justify-center'>
                <Slide bottom>
                    <form onSubmit={handleUpdate} className='border border-gray-400 shadow-2xl rounded-3xl p-5 lg:m-20 lg:w-1/3'>
